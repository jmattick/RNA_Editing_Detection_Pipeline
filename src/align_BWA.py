...
fastq_dir = None # path to directory containing WGS fastq files
fasta_dir = None # path to directory containing genome fasta file

for i in range(len(params)-1): #loop through parameters
    if params[i] == '-fq' or params[i] == '--fastq_dir': #if parameter is WGS fastq directory
